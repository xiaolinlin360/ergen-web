<template>
  <section class="legal-page" aria-label="公司简介">
    <div class="legal-wrap">
      <div class="legal-hero">
        <h1 class="legal-title">公司简介</h1>
        <p class="legal-updated">折耳根（深圳）健康管理有限公司</p>
      </div>
...
.company-brand-idea :deep(strong) {
  color: #065f46;
}
</style>
